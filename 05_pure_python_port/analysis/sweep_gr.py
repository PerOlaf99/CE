...
report("pm=7 baseline", {})
report("pm=7 + gap_rescan", dict(gap_rescan=True))
report("pm=7 + gr(ratio=1.4)", dict(gap_rescan=True, gap_rescan_ratio=1.4))
report("pm=7 + gr(ratio=1.8)", dict(gap_rescan=True, gap_rescan_ratio=1.8))
report("pm=7 + gr(prom=3)", dict(gap_rescan=True, gap_rescan_prom=3.0))
