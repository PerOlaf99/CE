...
class SequencingGUI(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        # -- Sliders panel --
        sliders_w = QWidget()
        sliders_w.setMinimumHeight(120)
        ...
        self.bl_slider.valueChanged.connect(self._schedule_update)
        ...
        self.sm_win_slider.valueChanged.connect(self._schedule_update)
        ...
        self.sm_ord_slider.valueChanged.connect(self._schedule_update)
        ...
        for i, label in enumerate(['T (Ch0)', 'G (Ch1)', 'C (Ch2)', 'A (Ch3)']):
            ...
            sp.setValue(85)
            sp.setSuffix('%')
            sl.valueChanged.connect(self._schedule_update)
