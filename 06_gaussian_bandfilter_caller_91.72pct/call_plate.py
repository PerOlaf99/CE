...
Winning configuration (tuned on the 96-well MB1000_M13_DT plate, canonical
perbase_vs_ref vs the clean M13 reference):
...
Plate mean identity 91.72% (median 92.01%), vs Cimarron 3.12 DLL 90.72%.
No reference, no ML model: pure DSP + peak tracking.
